...
--
CREATE DATABASE
IF NOT EXISTS `bacsvice_Reports` DEFAULT CHARACTER
SET utf8
COLLATE utf8_unicode_ci;
USE `bacsvice_Reports`;
...
UserID`,
`UserTypeID
`, `InnName`, `Password`, `ViewID`, `Email`) VALUES
...
--
ALTER TABLE `UserAPI`
ADD CONSTRAINT `UserAPI_ibfk_1` FOREIGN KEY
(`TypeID`) REFERENCES `APIType`
(`APITypeID`),
ADD CONSTRAINT `UserAPI_ibfk_2` FOREIGN KEY
...
(`UserTypeID`) REFERENCES `UserTypes`
(`UserTypeID`);
...
--
ALTER TABLE `WebPages`
ADD CONSTRAINT `WebPages_ibfk_1` FOREIGN KEY
(`UserID`) REFERENCES `Users`
(`UserID`);
COMMIT;
